...
### 1. Database Setup
![ERD](2_library system_managment/schema.png)
...
2. **Set Up the Database**: Run the SQL scripts provided in the `library_schema.sql` file to create and populate the database.
3. **Run the Queries**: Use the SQL queries provided in the `library_problem.sql` file to perform your analysis.
