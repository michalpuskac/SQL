...
-- list employee
-- they manager's ID
-- they manager's name  manager_id -> emp_id
SELECT * FROM employees;
SELECT * FROM branch;
...
-- use 28-04-2024 insted if current date
-- members , books, 
...
SELECT 
	...
	bk.book_title,
	ist.issued_date,
	'2024-04-28' - ist.issued_date as over_due_days
FROM issued_status AS ist
JOIN 
	members AS m
...
--issue and return book manually
SELECT * FROM books
